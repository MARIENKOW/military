...
<head>
    ...
    <?php require 'db.php'; ?>
<?php 
$cats = get_single_by_kategory($_GET['kategory']);
?>
                ...
                <div class="category__block">
                    ...
                    <div class="category__elements">
                        ...
                        ?>
                            ...
                            <div class="category__element" data-id="<?=$cat['kategory']?>">
                                <a class="element__lin" href="buy.php?id=<?php echo $cat['id']; ?>">
                                <img class="element__img" src="<?php echo $cat["img"]?>" alt="">
